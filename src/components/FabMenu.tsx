...
export default function FabMenu({ onFood, onWeight, onExercise }: Props) {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed bottom-28 right-5 sm:right-auto sm:left-1/2 sm:translate-x-[170px] z-50 flex flex-col items-center gap-3">
      ...
      <button
        ...
        className="fixed bottom-6 right-5 sm:right-auto sm:left-1/2 sm:translate-x-[170px] z-50
